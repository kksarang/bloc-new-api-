...
class _$ApiData extends ApiData {
  ...
  factory _$ApiData([void Function(ApiDataBuilder)? updates]) =>
      (new ApiDataBuilder()..update(updates))._build();

  _$ApiData._({this.result, required this.status, required this.message})
      : super._() {
  ...
  int get hashCode {
    return $jf(
        $jc($jc($jc(0, result.hashCode), status.hashCode), message.hashCode));
  }
    ...
    final _$result = _$v ??
        new _$ApiData._(
            ...
            status: BuiltValueNullFieldError.checkNotNull(
                status, r'ApiData', 'status'),
            message: BuiltValueNullFieldError.checkNotNull(
                message, r'ApiData', 'message'));
    replace(_$result);
    return _$result;
  }
}
